 ...
 */
class CRM_Replytoemail_Upgrader_Base {

  /**
   * @var CRM_Replytoemail_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Replytoemail_Upgrader(
   ...
   *
   * ```
   * CRM_Replytoemail_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Replytoemail_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
